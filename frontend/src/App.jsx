...
import TambahMatakuliah from './tambahmatakuliah'; // Impor komponen TambahMahasiswa
import './index.css';
      ...
      <div style={{ display: 'flex' }}>
        <div className='sidebar'>
          ...
          <ul style={{ listStyleType: 'none', padding: 0 }}>
            <li><Link to="/ipk">KRS</Link></li>
            <li><Link to="/tambah-mahasiswa">Tambah Mahasiswa</Link></li>
            <li><Link to="/tambah-matakuliah">Tambah Mata Kuliah</Link></li>
          </ul>
        </div>
        ...
        <div style={{ flex: 1, padding: '10px' }}>
          <Routes>
            ...
            <Route path="/tambah-matakuliah" element={<TambahMatakuliah />} />
          </Routes>
        </div>
      </div>
    </Router>
